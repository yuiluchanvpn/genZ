...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Auther : ${green}YUILUCHANVPN® ${NC}${YELLOW}(${NC} ${green} XPRESS ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/yuiluchanvpn/genZ/main/"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/yuiluchan"}]]}' 
...
wget -q https://raw.githubusercontent.com/yuiluchanvpn/genZ/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
